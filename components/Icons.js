...
export function HomeIconEmpty({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 ${className}`}
...
export function SearchIconEmpty({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 ${className}`}
...
export function BellIconEmpty({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 ${className}`}
...
export function MailboxIconEmpty({ className }) {
  return (
    <svg
      viewBox="0 0 24 24"
      className={`fill-current stroke-current stroke-0 ${className}`}
